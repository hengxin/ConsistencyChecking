...
public class ExpTestSuite
{
	...
	public ExpTestSuite()
	{
		...
		this.testSuite.add(new ExpTestCase(20, 1000, 50));
		this.testSuite.add(new ExpTestCase(20, 1500, 50));
		this.testSuite.add(new ExpTestCase(20, 1800, 50));
		this.testSuite.add(new ExpTestCase(20, 2000, 50));
		...
		this.testSuite.add(new ExpTestCase(20, 10000, 50));
  		*/
...
//		this.testSuite.add(new ExpTestCase(20, 20000, 5));
		...
		this.testSuite.add(new ExpTestCase(5, 3000, 500));
		this.testSuite.add(new ExpTestCase(5, 5000, 500));
		this.testSuite.add(new ExpTestCase(5, 10000, 500));
		this.testSuite.add(new ExpTestCase(5, 15000, 500));
		this.testSuite.add(new ExpTestCase(5, 20000, 500));
		this.testSuite.add(new ExpTestCase(5, 25000, 500));
		this.testSuite.add(new ExpTestCase(5, 30000, 500));
		*/
...
//		this.testSuite.add(new ExpTestCase(20, 50000, 50));
		...
		this.testSuite.add(new ExpTestCase(2, 500, 500));
		this.testSuite.add(new ExpTestCase(2, 800, 500));
		this.testSuite.add(new ExpTestCase(2, 1000, 500));
		this.testSuite.add(new ExpTestCase(2, 1500, 500));
		this.testSuite.add(new ExpTestCase(2, 1800, 500));
		this.testSuite.add(new ExpTestCase(2, 2000, 500));
		this.testSuite.add(new ExpTestCase(2, 2500, 500));
		this.testSuite.add(new ExpTestCase(2, 3000, 500));
		this.testSuite.add(new ExpTestCase(2, 4000, 500));
		this.testSuite.add(new ExpTestCase(2, 5000, 100));
		this.testSuite.add(new ExpTestCase(2, 6000, 100));
		this.testSuite.add(new ExpTestCase(2, 8000, 100));
		this.testSuite.add(new ExpTestCase(2, 10000, 50));
		this.testSuite.add(new ExpTestCase(2, 12000, 50));
		this.testSuite.add(new ExpTestCase(2, 15000, 50));
		this.testSuite.add(new ExpTestCase(2, 20000, 50));
		this.testSuite.add(new ExpTestCase(2, 25000, 50));
		this.testSuite.add(new ExpTestCase(2, 30000, 50));

		this.testSuite.add(new ExpTestCase(5, 500, 500));
		this.testSuite.add(new ExpTestCase(5, 800, 500));
		this.testSuite.add(new ExpTestCase(5, 4000, 500));
		this.testSuite.add(new ExpTestCase(5, 6000, 500));
		this.testSuite.add(new ExpTestCase(5, 8000, 500));
		this.testSuite.add(new ExpTestCase(5, 10000, 50));
		this.testSuite.add(new ExpTestCase(5, 12000, 50));
		...
		this.testSuite.add(new ExpTestCase(8, 500, 50));
		this.testSuite.add(new ExpTestCase(8, 800, 50));
		this.testSuite.add(new ExpTestCase(8, 1000, 50));
		this.testSuite.add(new ExpTestCase(8, 1500, 50));
		this.testSuite.add(new ExpTestCase(8, 1800, 50));
		this.testSuite.add(new ExpTestCase(8, 2000, 50));
		this.testSuite.add(new ExpTestCase(8, 2500, 50));
		this.testSuite.add(new ExpTestCase(8, 3000, 50));
		this.testSuite.add(new ExpTestCase(8, 4000, 50));
		this.testSuite.add(new ExpTestCase(8, 5000, 50));
		this.testSuite.add(new ExpTestCase(8, 6000, 50));
		this.testSuite.add(new ExpTestCase(8, 8000, 50));
		this.testSuite.add(new ExpTestCase(8, 10000, 50));
		this.testSuite.add(new ExpTestCase(8, 12000, 50));
		this.testSuite.add(new ExpTestCase(8, 15000, 50));
		this.testSuite.add(new ExpTestCase(8, 20000, 50));
		this.testSuite.add(new ExpTestCase(8, 25000, 50));
		this.testSuite.add(new ExpTestCase(8, 30000, 50));

		this.testSuite.add(new ExpTestCase(10, 500, 50));
		this.testSuite.add(new ExpTestCase(10, 800, 50));
		this.testSuite.add(new ExpTestCase(10, 1000, 50));
		this.testSuite.add(new ExpTestCase(10, 1500, 50));
		this.testSuite.add(new ExpTestCase(10, 1800, 50));
		this.testSuite.add(new ExpTestCase(10, 2000, 50));
		this.testSuite.add(new ExpTestCase(10, 2500, 50));
		this.testSuite.add(new ExpTestCase(10, 3000, 50));
		this.testSuite.add(new ExpTestCase(10, 4000, 50));
		this.testSuite.add(new ExpTestCase(10, 5000, 50));
		this.testSuite.add(new ExpTestCase(10, 6000, 50));
		this.testSuite.add(new ExpTestCase(10, 8000, 50));
		this.testSuite.add(new ExpTestCase(10, 10000, 50));
		this.testSuite.add(new ExpTestCase(10, 12000, 50));
		this.testSuite.add(new ExpTestCase(10, 15000, 50));
		this.testSuite.add(new ExpTestCase(10, 20000, 50));
		this.testSuite.add(new ExpTestCase(10, 25000, 50));
		this.testSuite.add(new ExpTestCase(10, 30000, 50));

		this.testSuite.add(new ExpTestCase(12, 500, 50));
		this.testSuite.add(new ExpTestCase(12, 800, 50));
		this.testSuite.add(new ExpTestCase(12, 1000, 50));
		this.testSuite.add(new ExpTestCase(12, 1500, 50));
		this.testSuite.add(new ExpTestCase(12, 1800, 50));
		this.testSuite.add(new ExpTestCase(12, 2000, 50));
		this.testSuite.add(new ExpTestCase(12, 2500, 50));
		this.testSuite.add(new ExpTestCase(12, 3000, 50));
		this.testSuite.add(new ExpTestCase(12, 4000, 50));
		this.testSuite.add(new ExpTestCase(12, 5000, 50));
		this.testSuite.add(new ExpTestCase(12, 6000, 50));
		this.testSuite.add(new ExpTestCase(12, 8000, 50));
		this.testSuite.add(new ExpTestCase(12, 10000, 50));
		this.testSuite.add(new ExpTestCase(12, 12000, 50));
		this.testSuite.add(new ExpTestCase(12, 15000, 50));
		this.testSuite.add(new ExpTestCase(12, 20000, 50));
		this.testSuite.add(new ExpTestCase(12, 25000, 50));
		this.testSuite.add(new ExpTestCase(12, 30000, 50));

		this.testSuite.add(new ExpTestCase(15, 500, 50));
		this.testSuite.add(new ExpTestCase(15, 800, 50));
		this.testSuite.add(new ExpTestCase(15, 1000, 50));
		this.testSuite.add(new ExpTestCase(15, 1500, 50));
		this.testSuite.add(new ExpTestCase(15, 1800, 50));
		this.testSuite.add(new ExpTestCase(15, 2000, 50));
		this.testSuite.add(new ExpTestCase(15, 2500, 50));
		this.testSuite.add(new ExpTestCase(15, 3000, 50));
		this.testSuite.add(new ExpTestCase(15, 4000, 50));
		this.testSuite.add(new ExpTestCase(15, 5000, 50));
		this.testSuite.add(new ExpTestCase(15, 6000, 50));
		this.testSuite.add(new ExpTestCase(15, 8000, 50));
		this.testSuite.add(new ExpTestCase(15, 10000, 50));
		this.testSuite.add(new ExpTestCase(15, 12000, 50));
		this.testSuite.add(new ExpTestCase(15, 15000, 50));
		this.testSuite.add(new ExpTestCase(15, 20000, 50));
		this.testSuite.add(new ExpTestCase(15, 25000, 50));
		this.testSuite.add(new ExpTestCase(15, 30000, 50));

		this.testSuite.add(new ExpTestCase(20, 500, 50));
		this.testSuite.add(new ExpTestCase(20, 800, 50));
		this.testSuite.add(new ExpTestCase(20, 4000, 50));
		this.testSuite.add(new ExpTestCase(20, 6000, 50));
		this.testSuite.add(new ExpTestCase(20, 8000, 50));
		this.testSuite.add(new ExpTestCase(20, 10000, 50));
		this.testSuite.add(new ExpTestCase(20, 12000, 50));
